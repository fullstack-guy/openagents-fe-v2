...
const ChatData = [
  ...
  },
  {
    ...
    messages: [
      ...
      {
        created_at: sub(new Date(), { minutes: 1 }),
        msg: chance.sentence({ words: 5 }),
        senderId: uniqueId(),
        type: 'text',
        attachment: [],
  ...
  },
  {
    ...
    messages: [
      {
        created_at: sub(new Date(), { hours: 10 }),
        msg: chance.sentence({ words: 5 }),
        senderId: 1,
        type: 'text',
        attachment: [
  ...
  },
  {
    ...
    messages: [
      ...
      {
        created_at: sub(new Date(), { hours: 11 }),
        msg: bg1,
        senderId: uniqueId(),
        type: 'image',
        attachment: [],
  ...
  },
  {
    ...
    messages: [
      ...
      {
        created_at: sub(new Date(), { minutes: 2 }),
        msg: chance.sentence({ words: 5 }),
        senderId: 6,
        type: 'text',
        attachment: [],
  ...
  },
  {
    ...
    messages: [
      ...
      {
        created_at: sub(new Date(), { minutes: 15 }),
        msg: chance.sentence({ words: 5 }),
        senderId: 7,
        type: 'text',
        attachment: [],
      ...
      {
        created_at: sub(new Date(), { minutes: 10 }),
        msg: chance.sentence({ words: 5 }),
        senderId: 7,
        type: 'text',
        attachment: [],
  ...
  },
  {
    ...
    messages: [
      ...
      {
        created_at: sub(new Date(), { hours: 6 }),
        msg: chance.sentence({ words: 5 }),
        senderId: 3,
        type: 'text',
        attachment: [],
  ...
  },
  {
    ...
    messages: [
      ...
      {
        created_at: sub(new Date(), { hours: 8 }),
        msg: chance.sentence({ words: 5 }),
        senderId: 3,
        type: 'text',
        attachment: [],
